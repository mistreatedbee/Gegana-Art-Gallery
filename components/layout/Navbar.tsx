    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? 'bg-ink/80 backdrop-blur-md py-4 border-b border-white/5'
            : 'bg-transparent py-6'
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-6 pl-8 border-l border-white/20">
              ...
              <Link
                href="/#contact"
                className="border border-gold text-gold hover:bg-gold hover:text-ink px-6 py-2 text-sm font-sans tracking-widest uppercase transition-all duration-300"
              >
                Book Consultation
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center space-y-8">
              ...
              >
                <Link
                  href="/#contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="border border-gold text-gold px-8 py-3 text-sm font-sans tracking-widest uppercase"
                >
                  Book Consultation
                </Link>
              </motion.div>
