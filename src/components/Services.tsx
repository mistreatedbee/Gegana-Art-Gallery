...
const services = [
{
  icon: Palette,
  title: 'Art Sales',
  desc: 'Acquire museum-quality contemporary works.'
},
{
  icon: Compass,
  title: 'Art Consultation',
  desc: 'Expert guidance on building meaningful collections.'
},
{
  icon: Users,
  title: 'Collector Advisory',
  desc: 'Strategic acquisition and portfolio management.'
},
{
  icon: Home,
  title: 'Interior Art Placement',
  desc: 'Curating art for luxury residential and commercial spaces.'
},
{
  icon: Presentation,
  title: 'Exhibition Curation',
  desc: 'Designing immersive and narrative-driven showcases.'
},
{
  icon: Sparkles,
  title: 'Artist Representation',
  desc: 'Nurturing and elevating visionary African talent.'
}];
    ...
    <section className="bg-ink py-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          <h2 className="text-bone font-serif text-5xl md:text-6xl">
            Gallery Services
          </h2>
        </motion.div>
          ...
          {services.map((service, idx) => {
            ...
            return (
              <motion.div
                ...
                <h3 className="text-bone font-serif text-2xl mb-4">
                  {service.title}
                </h3>
                <p className="text-bone/60 font-sans font-light text-sm leading-relaxed">
                  {service.desc}
                </p>
              </motion.div>);
