          ...
          <div className="py-12">
            <motion.div
              ...
              <div className="space-y-8 text-ink/80 font-sans font-light text-lg leading-relaxed">
                <p>
                  Founded in 2018, Gegana Gallery has established itself as a
                  premier destination for contemporary African art in
                  Johannesburg. We believe in the power of visual storytelling
                  to bridge cultures and challenge perspectives.
                </p>
                <p>
                  Our mission is to provide a global platform for both
                  established masters and emerging talents from the continent
                  and its diaspora. We curate exhibitions that are not just
                  visually stunning, but intellectually provocative.
                </p>
                <p>
                  For collectors, we offer an unparalleled advisory experience,
                  guiding both seasoned connoisseurs and new enthusiasts in
                  building meaningful, museum-quality collections that stand the
                  test of time.
                </p>
              </div>
            </motion.div>
        ...
        <div className="mt-32 pt-16 border-t border-ink/10 grid grid-cols-2 md:grid-cols-4 gap-12">
          ...
          <motion.div
            ...
            className="text-center">
              ...
              <div className="text-ink/60 font-sans text-xs tracking-widest uppercase">
                {stat.label}
              </div>
            </motion.div>
          )}
